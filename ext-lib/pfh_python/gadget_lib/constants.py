...
## below we simply initialize a bunch of constants for GADGET units
...
units_mass = msol*mass_in_msun
units_length = kpc
units_velocity = 1.0e5
units_m=units_mass
units_l=units_length
units_v=units_velocity
